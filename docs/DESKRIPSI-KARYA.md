...
Sistem mencatat setiap panggilan AI dan membandingkan hasil bacaannya dengan koreksi admin, sehingga akurasi terukur — bukan diklaim. Verifikasi pertama menunjukkan akurasi 80%, dan dua kolom yang meleset langsung menghasilkan perbaikan instruksi.
...
Akurasi pembacaan diukur dari koreksi admin, bukan diklaim — verifikasi pertama mencatat 80%.
...
| Angka 80% disebut, dan disebut cara mengukurnya | Klaim berangka lebih dipercaya daripada kata "akurat" |
...
- [ ] Angka akurasi, bila sudah lebih dari satu poster diverifikasi
