...
<div class="mx-auto max-w-md py-6 sm:py-12">
    ...
    <div data-reveal class="text-center">
        ...
        <h1 class="mt-5 font-judul text-3xl font-bold tracking-tight text-white">Buat akun</h1>
    ...
    <form method="POST" action="{{ route('daftar.simpan') }}" class="mt-8 space-y-4">
        ...
        <x-kartu datar data-reveal data-reveal-jeda="100" class="space-y-5">
            <p class="flex items-center gap-2 text-[0.68rem] font-semibold uppercase
                      tracking-[0.14em] text-utama-300">
                <span class="grid h-5 w-5 place-items-center rounded-md bg-utama-500/15
                             text-[0.65rem] ring-1 ring-inset ring-utama-400/25">1</span>
                Akun
            </p>
        ...
        <x-kartu datar data-reveal data-reveal-jeda="180" class="space-y-5">
            <p class="flex items-center gap-2 text-[0.68rem] font-semibold uppercase
                      tracking-[0.14em] text-utama-300">
                <span class="grid h-5 w-5 place-items-center rounded-md bg-utama-500/15
                             text-[0.65rem] ring-1 ring-inset ring-utama-400/25">2</span>
                Profil akademik
            </p>
    ...
    <p data-reveal data-reveal-jeda="300" class="mt-6 text-center text-sm text-slate-400">
        Sudah punya akun?
        <a href="{{ route('masuk') }}"
           class="font-semibold text-utama-300 underline-offset-2 hover:underline">Masuk di sini</a>
    </p>
