...
<div class="mx-auto max-w-xl">
    ...
    <h1 class="text-2xl font-semibold tracking-tight">Unggah poster</h1>
    ...
    <form method="POST" action="{{ route('unggah.simpan') }}" enctype="multipart/form-data"
        ...
        <div>
            <label for="poster" class="block text-sm font-medium text-slate-700">Berkas poster</label>
            ...
            <input id="poster" name="poster" type="file" required
                   ...
                   class="mt-1 w-full rounded-md border border-slate-300 bg-white p-2 text-sm
                          file:mr-3 file:rounded-md file:border-0 file:bg-utama-50 file:px-3 file:py-1.5
                          file:text-sm file:font-medium file:text-utama-700 hover:file:bg-utama-100">

            <p class="mt-1 text-xs text-slate-500">JPG, PNG, atau WebP. Maksimal 8 MB.</p>
        ...
        <x-kartu class="bg-slate-50 p-4">
            <p class="text-sm font-medium text-slate-700">Yang terjadi setelah kamu kirim</p>
        ...
        <div data-penanda-tunggu hidden
             class="flex items-center gap-3 rounded-md border border-utama-200 bg-utama-50 px-4 py-3"
            ...
            <div class="text-sm text-utama-800">
