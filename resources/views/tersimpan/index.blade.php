...
<h1 class="text-2xl font-semibold tracking-tight">Peluang tersimpan</h1>
...
@if ($peluang->isEmpty())
    ...
    <x-kartu class="mt-6 border-dashed p-10 text-center">
        <p class="text-sm font-medium text-slate-700">Belum ada yang disimpan</p>
...
@else
    ...
    <p class="mt-6 text-sm text-slate-500">
        <strong class="text-slate-700">{{ $peluang->total() }}</strong> peluang tersimpan
    </p>
